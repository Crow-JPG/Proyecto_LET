...
# Introducción
 ...
 Lo primero que decidí hacer fue sacar las correlaciones de las distintas variables con mi variable de interés. Esto con el objetivo de ver qué característica es la que afecta más al bajo peso del bebé. Al hacerlo, obtuve esto:
