...
Datos_A = Datos_A[,-1]
Datos_A = Datos_A[,-15]
nombres = c("Circunferencia_Cabeza", "Largo", "Peso", "Gestacion", "Madre_Fumadora", "Edad_Madre", "Cigarrillos_Madre", "Altura_Madre", "Peso_Madre", "Edad_Padre", "Anios_Educación_Padre", "Cigarrillos_Padre", "Altura_Padre", "Peso_Bajo_Bebe")
